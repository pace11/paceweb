<?php
  ...
  $tampil = mysqli_query($koneksi, "SELECT * FROM tbl_descskills WHERE id_descskills='$_GET[id]'")
    ...
    <div class="box box-danger">
      <div class="box-header with-border">
        ...
        <div class="box-body">
          ...
          <form id="isi_data" name="tambah" action="?tampil=skills_editpro" method="post" enctype="multipart/form-data"
          class="form-horizontal">

          <input type="hidden" name="id" value="<?= $data['id_descskills']; ?>">
